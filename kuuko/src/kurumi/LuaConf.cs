...
//		public const string LUA_DIRSEP = "/";
		...
		//#else
		public static bool lua_readline(LuaState.lua_State L, CLib.CharPtr b, CLib.CharPtr p)
		{
...
//		}
		//#else
		public static void luai_apicheck(LuaState.lua_State L, bool o)	
		{
		...
		{ 
			return CLib.CharPtr.toCharPtr(String.Format("{0}", n)); //FIXME:
		}
		...
		public static double lua_str2number(CLib.CharPtr s, /*out*/ CLib.CharPtr[] end)
		{
		...
		public static bool luai_numeq(Double/*lua_Number*/ a, Double/*lua_Number*/ b) 
		{ 
			return ((a) == (b)); 
		}
		
		public static bool luai_numlt(Double/*lua_Number*/ a, Double/*lua_Number*/ b) 
		{ 
			return ((a) < (b)); 
		}
		
		public static bool luai_numle(Double/*lua_Number*/ a, Double/*lua_Number*/ b) 
		{ 
			return ((a) <= (b)); 
		}
