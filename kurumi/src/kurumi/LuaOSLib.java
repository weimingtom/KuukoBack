...
//			 
	...
	private final static luaL_Reg[] syslib = { new luaL_Reg(CharPtr.toCharPtr("clock"), new LuaOSLib_delegate("os_clock")), new luaL_Reg(CharPtr.toCharPtr("date"), new LuaOSLib_delegate("os_date")), new luaL_Reg(CharPtr.toCharPtr("difftime"), new LuaOSLib_delegate("os_difftime")), new luaL_Reg(CharPtr.toCharPtr("execute"), new LuaOSLib_delegate("os_execute")), new luaL_Reg(CharPtr.toCharPtr("exit"), new LuaOSLib_delegate("os_exit")), new luaL_Reg(CharPtr.toCharPtr("getenv"), new LuaOSLib_delegate("os_getenv")), new luaL_Reg(CharPtr.toCharPtr("remove"), new LuaOSLib_delegate("os_remove")), new luaL_Reg(CharPtr.toCharPtr("rename"), new LuaOSLib_delegate("os_rename")), new luaL_Reg(CharPtr.toCharPtr("setlocale"), new LuaOSLib_delegate("os_setlocale")), new luaL_Reg(CharPtr.toCharPtr("time"), new LuaOSLib_delegate("os_time")), new luaL_Reg(CharPtr.toCharPtr("tmpname"), new LuaOSLib_delegate("os_tmpname")), new luaL_Reg(null, null) };
