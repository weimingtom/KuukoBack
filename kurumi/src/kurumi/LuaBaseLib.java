...
//		 
	private static CharPtr generic_reader(lua_State L, Object ud, int[] size) { //uint - out
	...
	private final static luaL_Reg[] base_funcs = { new luaL_Reg(CharPtr.toCharPtr("assert"), new LuaBaseLib_delegate("luaB_assert")), new luaL_Reg(CharPtr.toCharPtr("collectgarbage"), new LuaBaseLib_delegate("luaB_collectgarbage")), new luaL_Reg(CharPtr.toCharPtr("dofile"), new LuaBaseLib_delegate("luaB_dofile")), new luaL_Reg(CharPtr.toCharPtr("error"), new LuaBaseLib_delegate("luaB_error")), new luaL_Reg(CharPtr.toCharPtr("gcinfo"), new LuaBaseLib_delegate("luaB_gcinfo")), new luaL_Reg(CharPtr.toCharPtr("getfenv"), new LuaBaseLib_delegate("luaB_getfenv")), new luaL_Reg(CharPtr.toCharPtr("getmetatable"), new LuaBaseLib_delegate("luaB_getmetatable")), new luaL_Reg(CharPtr.toCharPtr("loadfile"), new LuaBaseLib_delegate("luaB_loadfile")), new luaL_Reg(CharPtr.toCharPtr("load"), new LuaBaseLib_delegate("luaB_load")), new luaL_Reg(CharPtr.toCharPtr("loadstring"), new LuaBaseLib_delegate("luaB_loadstring")), new luaL_Reg(CharPtr.toCharPtr("next"), new LuaBaseLib_delegate("luaB_next")), new luaL_Reg(CharPtr.toCharPtr("pcall"), new LuaBaseLib_delegate("luaB_pcall")), new luaL_Reg(CharPtr.toCharPtr("print"), new LuaBaseLib_delegate("luaB_print")), new luaL_Reg(CharPtr.toCharPtr("rawequal"), new LuaBaseLib_delegate("luaB_rawequal")), new luaL_Reg(CharPtr.toCharPtr("rawget"), new LuaBaseLib_delegate("luaB_rawget")), new luaL_Reg(CharPtr.toCharPtr("rawset"), new LuaBaseLib_delegate("luaB_rawset")), new luaL_Reg(CharPtr.toCharPtr("select"), new LuaBaseLib_delegate("luaB_select")), new luaL_Reg(CharPtr.toCharPtr("setfenv"), new LuaBaseLib_delegate("luaB_setfenv")), new luaL_Reg(CharPtr.toCharPtr("setmetatable"), new LuaBaseLib_delegate("luaB_setmetatable")), new luaL_Reg(CharPtr.toCharPtr("tonumber"), new LuaBaseLib_delegate("luaB_tonumber")), new luaL_Reg(CharPtr.toCharPtr("tostring"), new LuaBaseLib_delegate("luaB_tostring")), new luaL_Reg(CharPtr.toCharPtr("type"), new LuaBaseLib_delegate("luaB_type")), new luaL_Reg(CharPtr.toCharPtr("unpack"), new LuaBaseLib_delegate("luaB_unpack")), new luaL_Reg(CharPtr.toCharPtr("xpcall"), new LuaBaseLib_delegate("luaB_xpcall")), new luaL_Reg(null, null) };
...
//		 
	...
	private final static luaL_Reg[] co_funcs = { new luaL_Reg(CharPtr.toCharPtr("create"), new LuaBaseLib_delegate("luaB_cocreate")), new luaL_Reg(CharPtr.toCharPtr("resume"), new LuaBaseLib_delegate("luaB_coresume")), new luaL_Reg(CharPtr.toCharPtr("running"), new LuaBaseLib_delegate("luaB_corunning")), new luaL_Reg(CharPtr.toCharPtr("status"), new LuaBaseLib_delegate("luaB_costatus")), new luaL_Reg(CharPtr.toCharPtr("wrap"), new LuaBaseLib_delegate("luaB_cowrap")), new luaL_Reg(CharPtr.toCharPtr("yield"), new LuaBaseLib_delegate("luaB_yield")), new luaL_Reg(null, null) };
